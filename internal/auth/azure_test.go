...
func TestExchangeOIDCToken_Success(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.FormValue("scope") != "https://management.azure.com/.default" {
			t.Errorf("Expected scope https://management.azure.com/.default")
		}
	...
	// Mock the token endpoint URL by using the test server
	// We'll need to temporarily modify the ExchangeOIDCToken to accept custom endpoint
	// For now, test the client construction
